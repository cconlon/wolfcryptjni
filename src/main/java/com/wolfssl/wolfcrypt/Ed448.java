...
public class Ed448 extends NativeStruct {
     ...
     * @throws IllegalArgumentException if size is not {@link #ED448_KEY_SIZE}
     ...
     *         no key has been loaded or the object was released)
     */
     ...
     * until verifyFinal() or another verifyInit(), so finish or restart it
