...
public class WolfCryptKeyPairGenerator extends KeyPairGeneratorSpi {
        ...
        if (type == KeyType.WC_EDDSA) {
            ...
            if (c == null) {
                throw new InvalidParameterException(
                    "EdDSA key size must be 255 (Ed25519) or 448 (Ed448), got: "
                    + keysize);
            }
    ...
    public synchronized KeyPair generateKeyPair() {
        ...
        switch (this.type) {
            ...
            case WC_EDDSA:
                ...
                if (this.edCurve == null) {
                    throw new RuntimeException(
                        "EdDSA curve not set, call initialize() first");
                }
    ...
    /**
     * wolfCrypt EdDSA key pair generator class. Defaults to Ed25519, curve
     * selectable via initialize().
     */
