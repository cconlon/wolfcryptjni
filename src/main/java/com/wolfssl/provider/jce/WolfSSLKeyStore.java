...
public class WolfSSLKeyStore extends KeyStoreSpi {
     ...
     * derives the public key natively), re-encodes the public half as X.509
     * SubjectPublicKeyInfo and compares bytes against the cert's public key
     * encoding. EdDSA SPKI DER is canonical (RFC 8410), so byte equality is
     * safe.</p>
     *
