...
public class WolfCryptEdDSAKeyTest {
    ...
    private static final Curve ED25519 = new Curve("Ed25519", 32, 44, 48);
    private static final Curve ED448 = new Curve("Ed448", 57, 69, 73);
    ...
    public void publicKeyEncodedMatchesNativeDer() throws Exception {
        ...
        WolfCryptEdDSAPublicKey pub = new WolfCryptEdDSAPublicKey("Ed25519",
    ...
    public void privateKeyEncodedMatchesNativeDer() throws Exception {
        ...
        Ed25519 k = new Ed25519();
        k.importPrivate(Ed25519TestVectors.SKEY1, Ed25519TestVectors.PKEY1);
        ...
        if (ed448Enabled) {
            ...
            assertArrayEquals(k448.exportPrivateKeyDer(), p448.getEncoded());
    ...
    public void privateKeySerialization() throws Exception {
        ...
        for (Curve c : curves()) {
            ...
            Object back = deserialize(serialize(priv));
            ...
            priv.destroy();
            assertTrue(((WolfCryptEdDSAPrivateKey)
                deserialize(serialize(priv))).isDestroyed());
        }
    }
    ...
    public void parameterSpec() {
        ...
        /* 255 ok, 256 rejected */
        new WolfCryptEdDSAParameterSpec(true, new byte[255]);
        try {
