...
JNIEXPORT jboolean JNICALL Java_com_wolfssl_wolfcrypt_FeatureDetect_AesXtsEnabled
  (JNIEnv* env, jclass jcl)
{
    (void)env;
    (void)jcl;
...
JNIEXPORT jboolean JNICALL Java_com_wolfssl_wolfcrypt_FeatureDetect_AesXtsStreamEnabled
  (JNIEnv* env, jclass jcl)
{
    (void)env;
    (void)jcl;
